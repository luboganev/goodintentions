...
public class MainActivity$$ViewInjector {
  public static void inject(Finder finder, final com.luboganev.goodintentions.ui.MainActivity target, Object source) {
    ...
    if (view == null) {
      throw new IllegalStateException("Required view with id '2131361796' for field 'mPackageName' was not found. If this view is optional add '@Optional' annotation.");
    }
    target.mPackageName = (android.widget.EditText) view;
    view = finder.findById(source, 2131361800);
    if (view == null) {
      throw new IllegalStateException("Required view with id '2131361800' for field 'mIntentionCategories' was not found. If this view is optional add '@Optional' annotation.");
    }
    ...
    if (view == null) {
      throw new IllegalStateException("Required view with id '2131361798' for field 'mData' was not found. If this view is optional add '@Optional' annotation.");
    }
    ...
    if (view == null) {
      throw new IllegalStateException("Required view with id '2131361801' for field 'mIntentionFlags' was not found. If this view is optional add '@Optional' annotation.");
    }
    ...
    if (view == null) {
      throw new IllegalStateException("Required view with id '2131361799' for field 'mMimeType' was not found. If this view is optional add '@Optional' annotation.");
    }
    target.mMimeType = (android.widget.EditText) view;
    view = finder.findById(source, 2131361797);
    if (view == null) {
      throw new IllegalStateException("Required view with id '2131361797' for field 'mClassName' was not found. If this view is optional add '@Optional' annotation.");
    }
    target.mClassName = (android.widget.EditText) view;
    view = finder.findById(source, 2131361795);
    if (view == null) {
      throw new IllegalStateException("Required view with id '2131361795' for field 'mAction' was not found. If this view is optional add '@Optional' annotation.");
    }
    target.mAction = (android.widget.EditText) view;
    view = finder.findById(source, 2131361794);
    if (view == null) {
      throw new IllegalStateException("Required view with id '2131361794' for field 'mActionSearchButton' was not found. If this view is optional add '@Optional' annotation.");
    }
